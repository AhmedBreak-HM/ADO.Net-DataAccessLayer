...
namespace ADODataAccess
{
    public class SqlDataAccessLayer
    {
        ...
        /// </summary>
        protected DataTable GetData(string commandText, List<DbParameter>? parameters, CommandType commandType = CommandType.StoredProcedure)
        {
        ...
        /// </summary>
        protected int ExecuteNonQuery(string commandText, List<DbParameter>? parameters, CommandType commandType = CommandType.StoredProcedure)
        {
            int result = -1;
            try
            {
        ...
        /// </summary>
        protected object ExecuteScalar(string commandText, List<SqlParameter>? parameters, CommandType commandType = CommandType.StoredProcedure)
        {
            object? result = null;
        ...
        /// </summary>
        protected DataTable GetDataByAdapter(string commandText, List<DbParameter>? parameters, CommandType commandType = CommandType.StoredProcedure)
        {
            DataTable dt = new DataTable();
            try
            {
